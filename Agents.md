...
**Action:**
1. Create a new release tag (e.g. `v1.2.0`) after the current changes are merged
2. Update the schema comments in both files:

```yaml
# cad-gallery.yaml
# yaml-language-server: $schema=https://raw.githubusercontent.com/schmiddim/freecad-actions/refs/tags/v1.2.0/schemas/cad-gallery.schema.json

# maker.yaml
# yaml-language-server: $schema=https://raw.githubusercontent.com/schmiddim/freecad-actions/refs/tags/v1.2.0/schemas/maker.schema.json
```
